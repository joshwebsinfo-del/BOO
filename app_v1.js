...
const app = {
    ...
    renderSidebar() {
        ...
        const menu = [
            ...
            {
                label: 'EduMentor AI', items: [
                    { id: 'edumentor', name: 'EduMentor App 🤖', roles: ['Admin', 'Teacher', 'Parent', 'Student'] }
                ]
            }
        ];
    ...
    async navigate(page) {
        ...
        switch (page) {
            ...
            case 'resources':
                ...
                break;
            case 'edumentor':
                window.location.href = '/edumentor.html';
                break;
            default:
    ...
    checkPermission(page) {
        ...
        const matrix = {
            ...
            'edumentor': ['Admin', 'Teacher', 'Parent', 'Student']
        };
